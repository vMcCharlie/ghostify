...
export const SHIELDED_POOL_ABI = [
  { type: 'function', name: 'deposit', stateMutability: 'payable', inputs: [{ name: 'commitment', type: 'bytes32' }], outputs: [{ name: 'leafIndex', type: 'uint32' }] },
  ...
  { type: 'function', name: 'privateWithdraw', stateMutability: 'nonpayable', inputs: [{ name: 'pA', type: 'uint256[2]' }, { name: 'pB', type: 'uint256[2][2]' }, { name: 'pC', type: 'uint256[2]' }, { name: 'root', type: 'bytes32' }, { name: 'nullifierHash', type: 'bytes32' }, { name: 'recipient', type: 'address' }], outputs: [] },
  { type: 'event', name: 'Deposit', inputs: [{ indexed: true, name: 'commitment', type: 'bytes32' }, { indexed: false, name: 'leafIndex', type: 'uint32' }, { indexed: false, name: 'newRoot', type: 'bytes32' }] },
  ...
  { type: 'event', name: 'PrivateWithdrawal', inputs: [{ indexed: true, name: 'nullifierHash', type: 'bytes32' }, { indexed: true, name: 'recipient', type: 'address' }, { indexed: false, name: 'recipientHash', type: 'bytes32' }] },
] as const;