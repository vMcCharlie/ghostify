...
export default function ShieldedPoolPage() {
  ...
  function selectedNote() { return notes.find(note => !note.spent && (note.pool || '0xaaa2b48f1152a393eb30f60041060bb56f4f72fd').toLowerCase() === pool?.toLowerCase()); }
